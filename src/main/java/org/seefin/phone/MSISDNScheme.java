...
public class MSISDNScheme {
   ...
   */
  boolean isValid(int cc, int ndc, int sn) {
  ...
  static MSISDNScheme getSchemeForCC(int cc, int length) {
   ...
   */
  static MSISDNScheme parse(final String specification, String schemeName) {
   ...
   */
  static MSISDN fromLong(long value) {
